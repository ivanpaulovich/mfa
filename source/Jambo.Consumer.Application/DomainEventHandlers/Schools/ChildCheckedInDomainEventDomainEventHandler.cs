...
{
    public class ChildAddedDomainEventDomainEventHandler : IRequestHandler<ChildAddedDomainEvent>
    {
        ...
        public ChildAddedDomainEventDomainEventHandler(
        ...
        public void Handle(ChildAddedDomainEvent domainEvent)
        {
