...
{
    public class ParentAddedDomainEventDomainEventHandler : IRequestHandler<ParentAddedDomainEvent>
    {
        ...
        public ParentAddedDomainEventDomainEventHandler(
        ...
        public void Handle(ParentAddedDomainEvent domainEvent)
        {
